...
function MapView() {
  ...
  return (
    ...
    <Container>
      ...
      <Row>
        ...
        <div ref={mapContainer} style={{width:"100vh" ,borderRadius:"8px 8px 8px 8px",position:"relative", minHeight:"100vh",border:"1px groove grey"}} >
        <Row style={{position:"relative",top:"0",zIndex:"1",margin:"6px"}}>
        <Col style={{backgroundColor:'white',color:"black",minHeight:"15vh",boxShadow:"5px 5px 5px 5px grey",margin:"0",alignItems:"center"}}>
          
        <MapboxAutocomplete
          publicKey={mapAccess.mapboxApiAccessToken}
          inputClass="form-control search"
          onSuggestionSelect={_suggestionStartSelect} 
          country="in" style={{borderbottom:"2px solid black"}}
          resetSearch={false}
          placeholder="&#x25FC;   Start Location"></MapboxAutocomplete><MapboxAutocomplete
          publicKey={mapAccess.mapboxApiAccessToken}
          inputClass="form-control search" 
 ...
 <Button variant="dark" onClick={()=>{
                       findRoute();}} style={{margin:"5px",}} >Confirm Route</Button>           
<br/>
                        </Col>
      </Row>                 
...
<ThreeCard  basePrice={basePrice} standardPrice={standardPrice} premiumPrice={premiumPrice}/>
